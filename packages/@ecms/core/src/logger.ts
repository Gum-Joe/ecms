...
export class LoggerFactory {
	...
	*/
	public createLogger(moduleName: string): winston.Logger {
		const options: winston.LoggerOptions = {
			transports: [
				...
				new winston.transports.DailyRotateFile({
					...
					datePattern: "YYYY-MM", // see https://momentjs.com/docs/#/displaying/format/ - controls when logs rotated (once a month as system won't be used daily)
					zippedArchive: true,
		...
		if (process.env.ECMS_LOG_SILENT === "true" || process.env.NODE_ENV === "test") {
